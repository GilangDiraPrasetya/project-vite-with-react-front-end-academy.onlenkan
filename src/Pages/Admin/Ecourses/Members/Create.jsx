    ...
    <Admin>
      <section className="py-4">
        <div className="d-flex flex-md-row flex-column align-items-start align-items-md-center gap-3">
          <a href="{{ route('users.index') }}" className="btn btn-light d-flex align-items-center justify-content-center">
            <ArrowLeft />
          </a>
          <h5 className="text-dark m-0">Buat User Baru</h5>
        </div>
              ...
              <div className="row">
                <div className="col-md-8">
                  <div className="mb-3">
                    ...
                    <input type="text" name="name" id="name" className="form-control" placeholder="Ex: Muhammad Yunus Almeida etc." autofocus required />
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="mb-3">
                    <label for="photo">Foto</label>
                    <input type="file" name="photo" id="photo" className="form-control" accept="image/*" required />
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="mb-3">
                    <label for="email">Alamat Email</label>
                    <input type="email" name="email" id="email" className="form-control" placeholder="Ex: yunus@onlenkan.com etc." required />
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="mb-3">
