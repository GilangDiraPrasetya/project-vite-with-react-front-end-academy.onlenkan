    ...
    <Admin>
      <section className="py-4">
        <div className="d-flex flex-md-row flex-column align-items-start align-items-md-center gap-3">
          ...
          <h5 className="text-dark m-0">Edit Source Code Personal Website Creative Designed</h5>
        </div>

        <div className="card border-0 mt-4">
          <div className="card-body p-4">
            <form action="{{ route('source-code.update', $resource->id) }}" method="post" enctype="multipart/form-data">
              <div className="row">
                <div className="col-md-8">
                  <div className="mb-3">
                    <label for="title">Judul Code*</label>
                    <input type="text" name="title" id="title" className="form-control" placeholder="Ex: Template Admin" value="Personal Website Creative Designed" required autofocus />
                  </div>
                </div>
                ...
                <div className="col-md-6">
                  <div className="mb-3">
                    ...
                    <input type="file" name="files" id="files" className="form-control" placeholder="Usahakan RAR Atau ZIP" accept=".zip,.rar,.7z,.gz" />
                    <span className="text-secondary fs-7">Kosongkan jika tidak ingin mengganti file</span>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="mb-3">
                    ...
                    <span className="text-secondary fs-7">Kosongkan jika tidak ingin mengganti gambar!</span>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="mb-3">
                ...
                <div className="col-md-6">
                  <div className="mb-3">
                    <label for="link_preview">Link Preview</label>
                    <input type="text" name="link_preview" id="link_preview" value="{{ $resource->link_preview }}" className="form-control" />
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="mb-3">
                    <label for="price">Harga</label>
                    <input type="number" name="price" id="price" value="50000" className="form-control" />
                ...
                <div className="col-md-4">
                  <div className="mb-3">
                    ...
                    <input type="number" name="price_discount" value="{{ $resource->price_dicount }}" id="price_discount" className="form-control" />
                    <span className="text-secondary fs-7">Kosongkan jika tidak ada diskon!</span>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="mb-3">
                    <label for="available_for">Diskon</label>
                ...
                <div className="col-12">
                  <div className="mb-3">
                    ...
                    <textarea name="description" id="description" cols="30" rows="10" className="form-control">
                      Source code ini dibuat dengan HTML CSS Bootstrap yang mana jika ingin mengikuti video tutorialnya ada di YouTube Yunus Almeida, klik  disini untuk melihat tutorialnya.
                    </textarea>
                  </div>
                </div>
                <div className="d-flex align-items-center gap-3 mt-4">
                  ...
                  <a href="{{ route('source-code.index') }}" className="btn btn-light">
                    Batal
                  </a>
                </div>
              </div>
