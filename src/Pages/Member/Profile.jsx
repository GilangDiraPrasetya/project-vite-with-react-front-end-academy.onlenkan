  ...
  return (
    <Member>
      <section className="py-4">
        <h4 className="text-dark">Profil Setting</h4>
        <p className="text-secondary">Masukkan informasi yang valid agar proses belajar lebih mudah</p>

        <ul className="nav nav-pills my-4 my-md-5 gap-1 gap-md-4" id="pills-tab" role="tablist">
          ...
          <div className="tab-pane fade show active" id="pills-personal" role="tabpanel" aria-labelledby="pills-personal-tab" tabindex="0">
            <div className="card border-0">
              <div className="card-body">
                    ...
                    <div className="col-md-2">
                      ...
                      {/* @else
                                        <img src="https://ui-avatars.com/api/?name={{ Auth::user()->name }}"
                                            alt="{{ Auth::user()->name }}" className="rounded-circle"
                ...
                <hr className="my-4" />
                <form action="{{ route('profil-saya.update', Auth::user()->id) }}" method="post">
                  <div className="row">
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form action="{{ route('profil-saya.update', Auth::user()->id) }}" method="post" enctype="multipart/form-data">
