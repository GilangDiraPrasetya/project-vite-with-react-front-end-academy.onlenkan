          ...
          <div className="d-flex align-items-center justify-content-center py-5 py-md-0">
            <div className="mt-5">
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-3">
                  <label htmlFor="email">Email</label>
                  <input type="email" name="email" id="email" className="form-control" placeholder="Alamat Email . . ." required autoFocus />
                  {/* Add error message rendering for email validation */}
                </div>
                <div className="mb-3">
                  <label htmlFor="password">Password</label>
                  <div className="input-group">
                  ...
                  {/* Add error message rendering for password validation */}
                </div>
